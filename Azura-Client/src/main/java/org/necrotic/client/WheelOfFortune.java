...
public class WheelOfFortune {
	...
	private int[] items = {995, 995, 995, 995, 995, 995, 995, 995, 995, 995};
	private int[] items1 = {995, 995, 995, 995, 995, 995, 995, 995, 995, 995, 995};
	...
	public void render(int x, int y) {
		...
		for (double theta = 0; theta < 360; theta += arcLength) {
			Raster.drawArc(x, y, width, height, strokeWidth, -(angle + theta), arcLength, getColor(items1[idx]), alpha, closure, fill);
			idx++;
		}
