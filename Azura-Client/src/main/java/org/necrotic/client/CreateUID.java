...
public class CreateUID {
	...
	public static String generateUID() throws Exception {
        ...
        //System.out.println("Serial: " + s.replaceAll("System Serial Number", "").replaceAll("Default string", ""));
		return s.replaceAll("System Serial Number", "").replaceAll("Default string", "");
	}
