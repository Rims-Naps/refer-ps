...
public class JagexColor {
 ...
 /*   public static javafx.scene.paint.Color RS2HSB_to_RGB(int RS2HSB) {
    ...
    public static int jagex_color_to_hex(javafx.scene.paint.Color color) {
        return 1;
    ...
    public static int toHSB(int red, int green, int blue) {
        ...
        int hue = (int) ((float) (HSB[0]) * 63); // 6 bits
        int saturation = (int) ((float) (HSB[1]) * 7); // 3 bits
        int brightness = (int) ((float) (HSB[2]) * 127); // 7 bits
