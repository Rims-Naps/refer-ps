...
public class ItemPanel extends JPanel {
	...
	private ProducingGraphicsBuffer imageProducer;
	...
	public ItemPanel(ItemEditor editor) {
		itemEditor = editor;
		imageProducer = new ProducingGraphicsBuffer(240, 334, this);
		invBackground = new Sprite("4");
		invTransBackground = new Sprite("5");
	}
	...
	public void paintComponent(Graphics g) {
		...
		Rasterizer3D.setAllPixelsToZero();

		Sprite inventoryModel = ItemDef.getSprite(itemEditor.getItemID(), 1, (itemEditor.isSelected() ? 0xffffff : 0), -1, false);
		Sprite bigInventoryModel = ItemDef.getSprite(itemEditor.getItemID(), 1, 0, 128, false);
