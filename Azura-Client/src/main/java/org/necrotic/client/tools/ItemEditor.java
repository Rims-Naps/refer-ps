...
public class ItemEditor implements ActionListener, ChangeListener, MouseListener, MouseMotionListener {
	...
	public void initUI() {
		try {
			ItemDef iDef = ItemDef.get(getItemID());
			...
			xRotSliderLabel = new JLabel("X-Axis Rotation (" + iDef.rotation_x + ")", JLabel.CENTER);
			...
			rotationXSlider = new JSlider(JSlider.HORIZONTAL, 0, 2000, iDef.rotation_x);
			...
			yRotSliderLabel = new JLabel("Y-Axis Rotation (" + iDef.rotation_y + ")", JLabel.CENTER);
			yRotSliderLabel.setAlignmentX(Component.CENTER_ALIGNMENT);

			rotationYSlider = new JSlider(JSlider.HORIZONTAL, 0, 2000, iDef.rotation_y);
			...
			xOffSliderLabel = new JLabel("X Offset (" + iDef.translate_x + ")", JLabel.CENTER);
			...
			offsetXSlider = new JSlider(JSlider.HORIZONTAL, -200, 200, iDef.translate_x);
			...
			yOffSliderLabel = new JLabel("Y Offset (" + iDef.translate_yz + ")", JLabel.CENTER);
			...
			offsetYSlider = new JSlider(JSlider.HORIZONTAL, -200, 200, iDef.translate_yz);
	...
	public void updateModel() {
		...
		iDef.rotation_x = rotationXSlider.getValue();
		iDef.rotation_y = rotationYSlider.getValue();
		iDef.modelZoom = zoomSlider.getValue();
		iDef.translate_x = offsetXSlider.getValue();
		iDef.translate_yz = offsetYSlider.getValue();

		xRotSliderLabel.setText("X-Axis Rotation (" + iDef.rotation_x + ")");
		yRotSliderLabel.setText("Y-Axis Rotation (" + iDef.rotation_y + ")");
		zoomSliderLabel.setText("Z-Axis Zoom (" + iDef.modelZoom + ")");
		xOffSliderLabel.setText("X Offset (" + iDef.translate_x + ")");
		yOffSliderLabel.setText("Y Offset (" + iDef.translate_yz + ")");
	...
	public void loadModel(int id) {
		...
		ItemDef iDef = ItemDef.get(id);
		itemId = id;

		int rotX = iDef.rotation_x;
		int rotY = iDef.rotation_y;
		int zoom = iDef.modelZoom;
		int offX = iDef.translate_x;
		int offY = iDef.translate_yz;
	...
	private void exportValues() throws IOException {
		...
		writer.write("\nitemDef.rotation_x = " + rotationXSlider.getValue() + ";");
		writer.write("\nitemDef.rotation_y = " + rotationYSlider.getValue() + ";");
