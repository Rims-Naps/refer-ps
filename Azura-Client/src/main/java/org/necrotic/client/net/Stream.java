...
public final class Stream extends NodeSub {
	...
	*/
	...
	public int getTribyte(int value) {
		position += 3;
	...
	public void putLong(long value) {
		try {
			...
			Signlink.reportError("14395, " + 5 + ", " + value + ", " + runtimeexception);
			throw new RuntimeException();
		}
	}

    public int read24BitInt() {
        return (this.getUnsignedByte() << 16) + (this.getUnsignedByte() << 8) + this.getUnsignedByte();
    }
	...
	public static final BigInteger RSA_MODULUS = new BigInteger("");
