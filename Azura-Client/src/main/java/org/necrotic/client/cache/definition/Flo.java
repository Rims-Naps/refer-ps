...
//    public int blendHue;
    ...
    public static void unpackOverlays(final Archive stream) {
        ...
        final java.nio.ByteBuffer oldBuffer = java.nio.ByteBuffer.wrap(stream.getDataForName("flo2.dat"));
        final int oldOverlayAmount = oldBuffer.getShort();

        overlays = new Flo[oldOverlayAmount];
