package org.necrotic.client.cache.config;
...
public final class Varp {
	...
	public static void load(Archive archive) {
		Stream buffer = new Stream(archive.getDataForName("varp.dat"));
		int size = buffer.getUnsignedShort();
		anInt702 = 0;

        //System.out.println("[Varp] loaded " + size + " varps.");
    ...
    public int[] getAnIntArray703() {
        return anIntArray703;
    }
}
