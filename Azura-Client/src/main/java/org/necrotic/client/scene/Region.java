...
import org.necrotic.client.cache.definition.ObjectDef;
import org.necrotic.client.net.Stream;
import org.necrotic.client.scene.util.TileUtilities;
...
public final class Region {
	...
	public static void method188(Scene worldController, int i, int j, int k, int l, CollisionMap class11, int[][][] ai, int i1, int j1, int k1) {
		if (l == 4) {
			l = 0;
		}
		int l1 = ai[l][i1][j];
		...
		if (k == 22) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj = new GameObject(j1, i, 22, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 10 || k == 11) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj1 = new GameObject(j1, i, 10, i2, j2, l1, k2, class46.animation, true);
			}
			if (obj1 != null) {
				int j5 = 0;
				if (k == 11) {
				...
				worldController.addObject(i3, byte1, l2, i5, (Renderable) obj1, k4, k1, j5, j, i1, j1);
			}
			if (class46.solid) {
		...
		if (k >= 12) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj2 = new GameObject(j1, i, k, i2, j2, l1, k2, class46.animation, true);
			}
			worldController.addObject(i3, byte1, l2, 1, (Renderable) obj2, 1, k1, 0, j, i1, j1);
			if (class46.solid) {
				class11.method212(class46.impenetrable, class46.width, class46.length, i1, j, i);
			}
			return;
		...
		if (k == 0) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj3 = new GameObject(j1, i, 0, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 1) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj4 = new GameObject(j1, i, 1, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 2) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj11 = new GameObject(j1, 4 + i, 2, i2, j2, l1, k2, class46.animation, true);
				obj12 = new GameObject(j1, j3, 2, i2, j2, l1, k2, class46.animation, true);
			}
			worldController.method282(anIntArray152[i], (Renderable) obj11, i3, j, byte1, i1, (Renderable) obj12, l2, anIntArray152[j3], k1, j1);
			if (class46.solid) {
				class11.method211(j, i, i1, k, class46.impenetrable);
			}
			return;
		...
		if (k == 3) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj5 = new GameObject(j1, i, 3, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 9) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj6 = new GameObject(j1, i, k, i2, j2, l1, k2, class46.animation, true);
			}
			worldController.addObject(i3, byte1, l2, 1, (Renderable) obj6, 1, k1, 0, j, i1, j1);
			if (class46.solid) {
				class11.method212(class46.impenetrable, class46.width, class46.length, i1, j, i);
			}
			return;
		...
		if (k == 4) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj7 = new GameObject(j1, 0, 4, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 5) {
			...
			if (l4 > 0) {
				j4 = ObjectDef.forID(worldController.fetchWallObjectNewUID(k1, i1, j)/*
				 * l4
				 * >>
				 * 14
				 * &
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj13 = new GameObject(j1, 0, 4, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 6) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj8 = new GameObject(j1, 0, 4, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 7) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj9 = new GameObject(j1, 0, 4, i2, j2, l1, k2, class46.animation, true);
			}
		...
		if (k == 8) {
			...
			if (class46.animation == -1 && class46.morphisms == null) {
				...
				obj10 = new GameObject(j1, 0, 4, i2, j2, l1, k2, class46.animation, true);
			}
	...
	public Region(byte[][][] settings, int[][][] map) {
		maximumPlane = 99;
		landscapeSizeX = 104;
		landscapeSizeY = 104;
		tileHeights = map;
	...
	public final void createRegionScene(CollisionMap[] collisionMaps, Scene worldController) {
		for (int j = 0; j < 4; j++) {
			for (int k = 0; k < 104; k++) {
			...
			for (int x = -5; x < landscapeSizeX + 5; x++) {
				for (int z = 0; z < landscapeSizeY; z++) {
					...
					if (xForwardOffset >= 0 && xForwardOffset < landscapeSizeX) {
						...
						if (underlayId > 0) {
							if (underlayId >= Flo.underlays.length) {
								underlayId = Flo.underlays.length;
							}
							Flo flo = Flo.underlays[underlayId - 1];
					...
					if (xBackwardOffset >= 0 && xBackwardOffset < landscapeSizeX) {
						...
						if (underlayId > 0) {
							...
							Flo flo_1 = Flo.underlays[underlayId - 1];
						...
						if (y >= 1 && y < landscapeSizeY - 1 && (!(lowDetail || Configuration.TOGGLE_ROOF_OFF) || (tileFlags[0][x][y] & 2) != 0 || (tileFlags[plane][x][y] & 0x10) == 0 && getCollisionPlane(y, plane, x) == currentPlane)) {
							...
							if (underlayA > 0 || overlayA > 0) {
								...
								if (plane > 0) {
									...
									if (overlayA > 0 && !Flo.overlays[overlayA - 1].occlude) {
										occlude = false;
									}
								...
								int i22 = 0;
								if (j21 != -1) {
									i22 = Rasterizer3D.hsl2rgb[method187(k21, 96)];
								}
								if (overlayA == 0) {
									...
									if (floorTexture >= 0 && floorTexture <= 50) {
										mapTexture = Rasterizer3D.method369(floorTexture);
										j23 = -1;
										...
										mapTexture = Rasterizer3D.hsl2rgb[method185(flo_2.anInt399, 96)];
										j23 = -2;
										floorTexture = -1;
									} else {
									...
									if (overlayA - 1 == 54) {
										...
										mapTexture = Rasterizer3D.method369(1);
										j23 = -1;
										floorTexture = 1;
									}
									if (j23 == 111) { // Water
										...
										mapTexture = Rasterizer3D.method369(25);
										j23 = -1;
										floorTexture = 25;
									}
	...
	public void spawnObjectToWorld(int regionY, Scene scene, CollisionMap map, int type, int z, int regionX, int id, int rotation) {
	...
	*/
		...
		if (type == 22) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				object = new GameObject(id, rotation, 22, east, northEast, centre, north, definition.animation, true);

			scene.addGroundDecoration(z, mean, regionY, object, objectKey, key, regionX, id);
		...
		if (type == 10 || type == 11) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				object = new GameObject(id, rotation, 10, east, northEast, centre, north, definition.animation, true);
			...
			if (object != null) {
				...
				if (scene.addObject(key, objectKey, mean, length, ((Renderable) (object)), width, z, yaw, regionY, regionX, id) && definition.castsShadow) {
					Model model;
					...
					if (model != null) {
						for (int dx = 0; dx <= width; dx++) {
							for (int dy = 0; dy <= length; dy++) {
								int l5 = Math.max(30, model.XYZMag / 4);
		...
		if (type >= 12) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				object = new GameObject(id, rotation, type, east, northEast, centre, north, definition.animation, true);

			scene.addObject(key, objectKey, mean, 1, object, 1, z, 0, regionY, regionX, id);
		...
		if (type == 0) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				object = new GameObject(id, rotation, 0, east, northEast, centre, north, definition.animation, true);

			scene.method282(anIntArray152[rotation], ((Renderable) (object)), key, regionY, objectKey, regionX, null, mean, 0, z, id);
			...
			if (definition.decorDisplacement != 16)
				scene.method290(regionY, definition.decorDisplacement, regionX, z);
			return;
		}
		if (type == 1) {
			Renderable object;
			if (definition.animation == -1 && definition.morphisms == null)
				...
				object = new GameObject(id, rotation, 1, east, northEast, centre, north, definition.animation, true);

			scene.method282(anIntArray140[rotation], object, key, regionY, objectKey, regionX, null, mean, 0, z, id);
		...
		if (type == 2) {
			...
			if (definition.animation == -1 && definition.morphisms == null) {
				...
				obj11 = new GameObject(id, 4 + rotation, 2, east, northEast, centre, north, definition.animation, true);
				obj12 = new GameObject(id, oppositeOrientation, 2, east, northEast, centre, north, definition.animation, true);
			}

			scene.method282(anIntArray152[rotation], obj11, key, regionY, objectKey, regionX, obj12, mean, anIntArray152[oppositeOrientation], z, id);
			if (definition.occludes) {
				if (rotation == 0) {
					tileCullingBitmap[z][regionX][regionY] |= 0x249;
					tileCullingBitmap[z][regionX][regionY + 1] |= 0x492;
		...
		if (type == 3) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj5 = new GameObject(id, rotation, 3, east, northEast, centre, north, definition.animation, true);
			scene.method282(anIntArray140[rotation], ((Renderable) (obj5)), key, regionY, objectKey, regionX, null, mean, 0, z, id);
			if (definition.castsShadow)
				if (rotation == 0)
					shading[z][regionX][regionY + 1] = 50;
				else if (rotation == 1)
		...
		if (type == 9) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj6 = new GameObject(id, rotation, type, east, northEast, centre, north, definition.animation, true);
			scene.addObject(key, objectKey, mean, 1, ((Renderable) (obj6)), 1, z, 0, regionY, regionX, id);
			if (definition.solid && map != null)
				map.method212(definition.impenetrable, definition.width, definition.length, regionX, regionY, rotation);
			return;
		}
		...
		if (type == 4) {
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj7 = new GameObject(id, 0, 4, east, northEast, centre, north, definition.animation, true);
			scene.method283(key, regionY, rotation * 512, z, 0, mean, ((Renderable) (obj7)), regionX, objectKey, 0, anIntArray152[rotation]);
			return;
		}
		if (type == 5) {
			int i4 = 16;
			int k4 = scene.method300(z, regionX, regionY);
			if (k4 > 0)
			...
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj13 = new GameObject(id, 0, 4, east, northEast, centre, north, definition.animation, true);
			scene.method283(key, regionY, rotation * 512, z, anIntArray137[rotation] * i4, mean, ((Renderable) (obj13)), regionX, objectKey, anIntArray144[rotation] * i4, anIntArray152[rotation]);
			return;
		}
		if (type == 6) {
			Object obj8;
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj8 = new GameObject(id, 0, 4, east, northEast, centre, north, definition.animation, true);
			scene.method283(key, regionY, rotation, z, 0, mean, ((Renderable) (obj8)), regionX, objectKey, 0, 256);
			return;
		}
		if (type == 7) {
			Object obj9;
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj9 = new GameObject(id, 0, 4, east, northEast, centre, north, definition.animation, true);
			scene.method283(key, regionY, rotation, z, 0, mean, ((Renderable) (obj9)), regionX, objectKey, 0, 512);
			return;
		}
		if (type == 8) {
			Object obj10;
			if (definition.animation == -1 && definition.morphisms == null)
				...
				obj10 = new GameObject(id, 0, 4, east, northEast, centre, north, definition.animation, true);
			scene.method283(key, regionY, rotation, z, 0, mean, ((Renderable) (obj10)), regionX, objectKey, 0, 768);
		}
	}
	...
	public final void readObjectMap(CollisionMap[] aclass11, Scene worldController, int i, int j, int k, int l, byte[] abyte0, int i1, int j1, int k1) {
		label0:
		{
			Stream stream = new Stream(abyte0);
			int l1 = -1;
			do {
				...
				do {
					...
					if (j3 == i && i3 >= i1 && i3 < i1 + 8 && l2 >= k && l2 < k + 8) {
						...
						int j4 = j + TileUtilities.method157(j1, class46.length, i3 & 7, l2 & 7, class46.width);
						int k4 = k1 + TileUtilities.method158(l2 & 7, class46.length, j1, class46.width, i3 & 7);
	...
	public final void method190(int i, CollisionMap[] aclass11, int j, Scene worldController, byte[] abyte0) {
		label0:
		{
			Stream buffer = new Stream(abyte0);
			int l = -1;
