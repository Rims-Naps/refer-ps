package org.necrotic.client.scene.util;
...
public final class CollisionMap {
	...
	public void clipTableSet(int i, int k) {
		k -= anInt290;
		i -= anInt291;
		flags[k][i] |= 0x200000;
	}
	...
	public boolean reachedDecoration(int i, int j, int k, int l, int i1, int j1) {
		if (j1 == i && k == j) {
			return true;
		}
	...
	public boolean readObject(int i, int j, int k, int l, int i1, int j1, int k1) {
		int l1 = j + j1 - 1;
		int i2 = i + l - 1;
