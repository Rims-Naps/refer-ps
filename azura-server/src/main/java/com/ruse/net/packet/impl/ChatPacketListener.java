...
public class ChatPacketListener implements PacketListener {
    ...
    public void handleMessage(Player player, Packet packet) {
        ...
        if (WatchListManager.beingWatched(player.getUsername()))
            DiscordManager.sendMessage(player.getLocation().toString() + "|" + player.getPosition().getX() + "," + player.getPosition().getY() + "," + player.getPosition().getZ() + "|Said: " + readable, Channels.WATCHLIST_CHAT);
