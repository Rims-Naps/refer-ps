...
public enum FamiliarData {
	SPIRIT_WOLF(12047, 1, 4.8, 4, 0.1, 1, 12425, new Item(12158),new Item(
	...
	SPIRIT_SPIDER(12059, 10, 12.6, 6, 0.2, 2, 12428, new Item(12158),
	...
	DESERT_WYRM(12049, 18, 31.2, 9, 0.4, 1, 1, new Item(12159),new Item(
