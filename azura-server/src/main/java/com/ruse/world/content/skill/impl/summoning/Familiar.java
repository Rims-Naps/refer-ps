...
public class Familiar {
	...
	public Familiar(Player owner, NPC summonNpc) {
		BossPets.BossPet bossPet = BossPets.BossPet.forSpawnId(summonNpc.getId());
		this.owner = owner;
		this.summonNpc = summonNpc;
		this.petNpc = bossPet.isCanAttack();
		System.out.println(bossPet.isCanAttack());
		this.petNpc = bossPet.isCanHeal();
		System.out.println(bossPet.isCanHeal());
		this.deathTimer = -1;
	}
