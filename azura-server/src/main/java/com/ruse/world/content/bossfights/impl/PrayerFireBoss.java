...
public class PrayerFireBoss extends BossFight {

    private static final long HEALTH = 7500;

    public PrayerFireBoss(Player player) {
        super(player);
    }

    @Override
    public int npcId() {
        return 3171;//SET NPC ID
    }
    ...
    public void begin() {
        ...
        setCurrentNpc(new NPC(npcId(), new Position(1825, 5086, getMyHeight())));
        ...
        TeleportHandler.teleportPlayer(getPlayer(), new Position(1824, 5096, getMyHeight()), TeleportType.NORMAL);
    }
