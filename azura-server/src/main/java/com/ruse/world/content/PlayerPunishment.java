...
public class PlayerPunishment {
	...
	private static final String JAIL_FILE = "./data/saves/";
	...
	public static ArrayList<String> AccountsJailed = new ArrayList<>();
	...
	public static void init() {
		...
		initializeList(JAIL_FILE, "Jail", AccountsJailed);
	}
	...
	public static class Jail {
		...
		public static boolean jailPlayer(String name) {
			...
			if (AccountsJailed.contains(name))
				return false;
			AccountsJailed.add(name);
			addToFile("" + JAIL_FILE + "Jail.txt", name);
			return true;
		}
		...
		public static boolean unJail(String name) {
			...
			if (!AccountsJailed.contains(name))
				return false;
			deleteFromFile("" + JAIL_FILE + "Jail.txt", name);
			AccountsJailed.remove(name);
			return true;
		}

		public static boolean isJailed(String name) {
			return AccountsJailed.contains(Misc.formatPlayerName(name.toLowerCase()));
		}
	}
