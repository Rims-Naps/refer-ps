...
public class Fletching {
     ...
     */
    public static void openSelection(Player player, int log) {
     ...
     * @return
     */
    public static boolean fletchingButton(Player player, int button) {
        switch (button) {
            case 8889:
    ...
    public static void fletchBow(Player player, int product, int amountToMake) {
        player.getPacketSender().sendInterfaceRemoval();
        int log = player.getSelectedSkillingItem();
        player.getSkillManager().stopSkilling();
    ...
    public static void crushGems(Player player, int amount, int gemToCut) {
        int gem = player.getSelectedSkillingItem();
        player.getSkillManager().stopSkilling();
        player.getPacketSender().sendInterfaceRemoval();
        ...
        GemData gd = GemData.forGem(gemToCut);
    ...
    public static void tipBolt(Player player, int tip) {
        ...
        BoltData bd = BoltData.forTip(tip);
    ...
    public static void openBowStringSelection(Player player, int log) {
        for (StringingData g : StringingData.values()) {
            if (log == g.unStrung()) {
                player.getSkillManager().stopSkilling();
                player.setSelectedSkillingItem(log);
    ...
    public static void stringBow(Player player, int amount) {
        int log = player.getSelectedSkillingItem();
        player.getSkillManager().stopSkilling();
        player.getPacketSender().sendInterfaceRemoval();
        for (StringingData g : StringingData.values()) {
    ...
    public static void makeArrows(Player player, int item1, int item2) {
        player.getSkillManager().stopSkilling();
