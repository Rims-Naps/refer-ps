package com.ruse.world.content.new_raids_system.raids_loots.raids_one.phase_one;
 ...
 *
 */
public class VENGRAIDMINION extends NPC {
	
	public static int spawnTime = 1041;
	
	/**
	 * The npc id.
	 */
	public static final int FIRST_NPC_ID = RaidsConstants.CORRUPT_RAID_MINION;
	
	public VENGRAIDMINION(Position position) {
