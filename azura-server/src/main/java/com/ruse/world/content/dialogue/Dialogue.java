...
public abstract class Dialogue {
	...
	private boolean closesMainScreen = true;
	...
	public boolean isClosesMainScreen() {
		return closesMainScreen;
	}

	public void setClosesMainScreen(boolean closesMainScreen) {
		this.closesMainScreen = closesMainScreen;
	}
