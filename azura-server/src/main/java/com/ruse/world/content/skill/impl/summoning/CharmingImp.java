...
public class CharmingImp {
	...
	private static void turnIntoXp(Player player, int itemId, int amount) {
		switch (itemId) {
		case GOLD_CHARM:
			player.getSkillManager().addExperience(Skill.NECROMANCY, 18 * amount);
			break;
		case GREEN_CHARM:
			player.getSkillManager().addExperience(Skill.NECROMANCY, 21 * amount);
			break;
		case CRIM_CHARM:
			player.getSkillManager().addExperience(Skill.NECROMANCY, 29 * amount);
			break;
		case BLUE_CHARM:
			player.getSkillManager().addExperience(Skill.NECROMANCY, 37 * amount);
			break;
