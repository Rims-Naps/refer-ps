...
public class Construction {
	...
	public static void buyHouse(Player p) {
		...
		p.getPacketSender().sendMessage("You have purchased a house. Use the portal to enter it.");
	}
	...
	public static void enterHouse(Player me, Player houseOwner, boolean buildingMode) {
	...
	public static boolean roomExists(Player p) {
        ...
        return room != null && room.getType() != ConstructionData.BUILDABLE && room.getType() != ConstructionData.EMPTY
