...
public enum TeleportType {
	...
	NORMAL(4, new Animation(9606), new Animation(9013), new Graphic(1685), null),
	ANCIENT(4, new Animation(9606), new Animation(9013), new Graphic(1685), null),
	LUNAR(4, new Animation(9606), new Animation(9013), new Graphic(1685), null),
	TELE_TAB(2, new Animation( 7534), new Animation(3640), new Graphic(738), null),
	RING_TELE(2, new Animation( 7534), Animations.DEFAULT_RESET_ANIMATION, new Graphic(738), null),
	LEVER(-1, null, null, null, null),
	PURO_PURO(9, new Animation( 7534), Animations.DEFAULT_RESET_ANIMATION, new Graphic(738), null),
	...
	public Graphic getStartGraphic() {
		return this == NORMAL ? new Graphic(738) : startGraphic;
	}
