...
public class Jewelry {
	...
	public static void jewelryMaking(Player player, String type, int itemId, int amount) {
		switch (type) {
		case "RING":
	...
	private static void mouldJewelry(Player player, int required, int itemId, int amount,
			int level, int xp) {
	...
	public static enum amuletData {
		...
		private amuletData(int amuletId, int product) {
