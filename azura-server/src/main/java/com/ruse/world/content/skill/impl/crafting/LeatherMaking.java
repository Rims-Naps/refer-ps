...
public class LeatherMaking {
	...
	public static void craftLeatherDialogue(Player player, int itemUsed, int usedWith) {
		player.getSkillManager().stopSkilling();
		for (leatherData l : leatherData.values()) {
			int leather = (itemUsed == 1733 ? usedWith : itemUsed);
		...
		for (leatherDialogueData d : leatherDialogueData.values()) {
			int leather = (itemUsed == 1733 ? usedWith : itemUsed);
	...
	public static void craftLeather(Player player, leatherData l, int amount) {
