...
public class Herblore {
	...
	public static boolean cleanHerb(Player player, int herbId) {
	...
	public static boolean makeUnfinishedPotion(Player player, int herbId) {
		UnfinishedPotions unf = UnfinishedPotions.forId(herbId);
		if (unf == null)
			return false;
	...
	public static boolean finishPotion(Player player, int itemUsed, int usedWith) {
		FinishedPotions pot = FinishedPotions.forId(itemUsed, usedWith);
