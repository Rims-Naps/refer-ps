...
class Dungeoneering(val group: DungeoneeringParty) {
    ...
    fun finalize() {
        ...
        group.players.forEach {
            ...
            it.packetSender.sendDungeoneeringTabIcon(true).sendTabInterface(GameSettings.PLAYER_TAB, 27224).sendTab(GameSettings.PLAYER_TAB)
    ...
    companion object {
        ...
        fun leaveLobby(p: Player) {
            ...
            p.packetSender.sendTabInterface(GameSettings.PLAYER_TAB, 111000) //
            p.packetSender.sendDungeoneeringTabIcon(false)
            p.packetSender.sendTab(GameSettings.PLAYER_TAB)
           // }
