...
public class ExperienceLamps {
			...
			try {
				...
				if (player.getUsableObject()[0] != null) {
					...
					case "xp":
						...
						player.getPacketSender().sendMessage("You have received some experience in "
	...
	enum Interface_Buttons {
		...
		FARMING(-27475), BEAST_HUNTER(-27472), SUMMONING(-27469), CONSTITUTION(-27466), DUNGEONEERING(-27463),
	...
	public static int getExperienceReward(Player player, LampData lamp, Skill skill) {
		int base = lamp == LampData.GOLDENLAMP_LAMP ? (1000000)
				: (1100000);
