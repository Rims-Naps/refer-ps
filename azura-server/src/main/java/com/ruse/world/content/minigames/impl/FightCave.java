...
public class FightCave {
	...
	public static final int JAD_NPC_ID = -1;
	...
	public static void spawnJad(Player player) {
		TaskManager.submit(new Task(2, player, false) {
			@Override
			public void execute() {
				if (player.getRegionInstance() == null || !player.isRegistered() || player.getLocation() != Location.DUEL_ARENA) {
					stop();
					return;
				}
	...
	public static void handleJadDeath(Player player, NPC n) {
