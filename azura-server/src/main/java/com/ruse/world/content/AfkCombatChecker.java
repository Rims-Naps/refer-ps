...
public class AfkCombatChecker {
    ...
    public void openQuestions() {
            if (player.getLocation() == Locations.Location.HOME_BANK|| player.getLocation() == Locations.Location.AFKBOSS){
    ...
    public void moveHome(boolean answered) {
        ...
        DiscordManager.sendMessage("[AFK]<col=6600FF> " + player.getUsername() + " has FAILED the AFK checked. @red@Offenses: " + afkCaught, Channels.afkLog);
        if (answered)
        ...
        player.getPacketSender().sendString(83505, answered ? "@red@Answered incorrectly" : "@red@Didn't answer AFK Question");
        player.getPacketSender().sendString(83506, "Total offenses:\\n@red@" + afkCaught);
        player.getPacketSender().sendInterface(83500);
        ...
        if (afkCaught >= 3) {
            ...
            player.getPacketSender().sendString(83506, "Total offenses:\\n@red@" + afkCaught);
            DiscordManager.sendMessage("[AFK]<col=6600FF> " + player.getUsername() + " has FAILED the AFK checked and was jailed! " + afkCaught, Channels.afkLog);
        }
    }
    ...
    public enum Questions {
        NAME("What is the name of this server?", new String[]{"Athens", "OSRS", "Runescape"}),
        YEAR("What is year is it?", new String[]{"2025", "2011", "2030"}),
        ;
        private String question;
        private String[] answers;
    }
