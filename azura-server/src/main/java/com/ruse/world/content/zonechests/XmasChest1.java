...
public class XmasChest1 {
    private static final int KEY_ID = 1451;
    private static final  int[] SUPER_RARE = new int[] {1455, 1456, 1457, 1458 ,1459};
    private static final int[] RARE = new int[] {10945, 15667, 1452, 1453,1454};
    ...
    public static void generateReward(Player player){
        ...
        if (Misc.getRandom(750) == 1) {
            ...
            //player.getCollectionLogManager().addItem(CollectionLogs.CHRISTMAS_KEY_1, new Item(superrares));
            ...
            //player.getCollectionLogManager().addItem(CollectionLogs.CHRISTMAS_KEY_1, new Item(rares));

        }
        else if (Misc.getRandom(30) == 1) {
            int uncommons = getRandomItem(UNCOMMON);
            player.getInventory().add(uncommons, Misc.random(3,20));
            //player.getCollectionLogManager().addItem(CollectionLogs.CHRISTMAS_KEY_1, new Item(uncommons));


        } else {
            int commons = getRandomItem(COMMON);
            player.getInventory().add(commons, Misc.random(5,100));
            //player.getCollectionLogManager().addItem(CollectionLogs.CHRISTMAS_KEY_1, new Item(commons));
