...
public class EverthornFight extends BossFight {

    private static final long HEALTH = 75000;

    public EverthornFight(Player player) {
        super(player);
    }

    @Override
    public int npcId() {
        return 6323;//SET NPC ID
    }
    ...
    public void begin() {
        ...
        getPlayer().setEverthornStage(1);
        //Set Location for Boss Npc
        setCurrentNpc(new NPC(npcId(), new Position(2913, 4381, getMyHeight())));
        ...
        TeleportHandler.teleportPlayer(getPlayer(), new Position(2914, 4377, getMyHeight()), TeleportType.NORMAL);
    }
