...
public class MinigameAttributes {
	...
	private final HalloweenAttributes hwAttributes = new HalloweenAttributes();

	private final EasterQuestAtributes easterquestatributes = new EasterQuestAtributes();
	...
	public HalloweenAttributes getHalloweenAttributes(){
		return hwAttributes;
	}
	public EasterQuestAtributes getEasterQuestAtributes(){return easterquestatributes;}
	...
	public class HalloweenAttributes {
		private boolean[] questParts = new boolean[6];
		...
		public void reset() {
			questParts = new boolean[6];
		}
	}
	public class HalloweenAttributes1 {
		private boolean[] questParts = new boolean[8];
		...
		public void reset() {
			questParts = new boolean[8];
		}
	}
	public class HalloweenAttributes2 {
		private boolean[] questParts = new boolean[10];
		...
		public void reset() {
			questParts = new boolean[10];
		}
	}
	public class HalloweenAttributes3 {
		private boolean[] questParts = new boolean[12];
		...
		public void reset() {
			questParts = new boolean[12];
		}
	}

	public class EasterQuestAtributes {
		private boolean[] questParts = new boolean[12];
