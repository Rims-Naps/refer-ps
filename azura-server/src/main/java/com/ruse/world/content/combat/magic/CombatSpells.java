...
ICEYBLAST(new CombatNormalSpell() {
	...
	VENGEANCE_OTHER(new CombatEffectSpell() {
		...
		public void spellEffect(Character cast, Character castOn) {
			 ...
			 * caster.getPacketSender().sendMessage("CorruptRaid other failed."); } else {
			 * caster.getPacketSender().sendMessage("You cast CorruptRaid on "+player.
			 * getUsername()+".");
			 * player.getPacketSender().sendMessage("Your were given CorruptRaid by "+caster.
	...
	SMOKE_RUSH(new CombatAncientSpell() {
		...
		public void spellEffect(Character cast, Character castOn, int damage) {
			CombatFactory.burnentity(castOn, BurnType.BASE_PRAYER);
		}
		...
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			CombatFactory.burnentity(castOn, BurnType.TIER2_PRAYER);
		}
		...
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			CombatFactory.burnentity(castOn, BurnType.SUPER);
		}
		...
		@Override
		public Optional<Item[]> itemsRequired(Player player) {
			return Optional.of(new Item[] { new Item(-1, -1)});
		}
	...
	FIRE_1(new CombatNormalSpell() {
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(2187, GraphicHeight.MIDDLE));
		}
	...
	EARTH_1(new CombatNormalSpell() {
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 970, 44, 3, 10, 5, 0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(971, GraphicHeight.MIDDLE));
		}
	...
	CORRUPT_STAFF(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(2345, GraphicHeight.LOW));
		}
		...
		@Override
		public Optional<Graphic> startGraphic() {
			return Optional.of(new Graphic(311));
		}
	}),

	VOID_1(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 2188, 44, 3, 43, 31, 0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(2188, GraphicHeight.MIDDLE));
		}
	...
	LAVA_SPELL_1(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 498, 44, 3, 43, 31, 0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(498, GraphicHeight.LOW));
		}
	...
	AQUA_SPELL_1(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
	...
	SUMMERSPELL(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
		...
		@Override
		public Optional<Projectile> castProjectile(Character cast, Character castOn) {
			return Optional.of(new Projectile(cast, castOn, 1196, 44, 3, 43, 31, 0));
		}

		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(456, GraphicHeight.LOW));
		}
	...
	CANDY_CANEE(new CombatNormalSpell() {
		@Override
		public int baseExperience() {
			return 0;
		}
		...
		@Override
		public Optional<Graphic> endGraphic() {
			return Optional.of(new Graphic(369, GraphicHeight.LOW));
		}
	...
	CUSTOM_BURST_2(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	CUSTOM_BURST_3(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	CUSTOM_BURST_4(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
	...
	CUSTOM_BURST_10(new CombatAncientSpell() {
		@Override
		public void spellEffect(Character cast, Character castOn, int damage) {
			if (damage < 1) {
				return;
