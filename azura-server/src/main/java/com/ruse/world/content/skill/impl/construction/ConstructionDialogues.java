...
public class ConstructionDialogues {
	...
	public static Dialogue servantDialogue(Player p, int npc) {
		return new Dialogue() {
	...
	public static Dialogue hireServantDeclineDialogue(Player p, int npc, String errorReq) {
		return new Dialogue() {
			@Override
			public DialogueType type() {
				return DialogueType.NPC_STATEMENT;
	...
	public static Dialogue hireServantMakeDealDialogue(Player p, int npc) {
		return new Dialogue() {
			@Override
			public DialogueType type() {
				return DialogueType.NPC_STATEMENT;
	...
	public static Dialogue finalServantDealDialogue(boolean accepted) {
		return new Dialogue() {
			@Override
			public DialogueType type() {
				return DialogueType.PLAYER_STATEMENT;
	...
	public static Dialogue rotateObjectDialogue(Player p) {
		return new Dialogue() {
			@Override
			public DialogueType type() {
				return DialogueType.OPTION;
	...
	public static Dialogue withdrawSuppliesDialogue(Player p, int type) {
		return new Dialogue() {
			@Override
			public DialogueType type() {
				return DialogueType.OPTION;
	...
	public static Dialogue servantOptions(Player p, int type) {
		return new Dialogue() {
			...
			public String[] dialogue() {
				if (type == 455) {
					...
					Servant servant = (p.getRegionInstance() instanceof House ? (House) p.getRegionInstance()
	...
	public static Dialogue notPlayersButler(int butler) {
		return new Dialogue() {
	...
	public static Dialogue buildTrapdoor(Player p) {
		return new Dialogue() {
	...
	public static Dialogue crawlingHandDialogue4(Player p) {
		return new Dialogue() {
	...
	public static Dialogue sendConstructionStatement(String s) {
		return new Dialogue() {
