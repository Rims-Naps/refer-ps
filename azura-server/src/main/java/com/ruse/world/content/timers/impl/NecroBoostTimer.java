...
public class NecroBoostTimer extends EffectTimer {
    Player player;
    public NecroBoostTimer(Player player) {
        super(player,2093, "NecroBoost");
        this.player = player;
    }
    ...
    public void append() {
        ...
        if (isActive()){
            ...
            player.msgFancyPurp("You've started " + (minutes) + " Minutes of " + getName() + " effect!");
        }
        addTime(timeToAdd);
