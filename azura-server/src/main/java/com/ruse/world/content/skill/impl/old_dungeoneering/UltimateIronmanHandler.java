...
public class UltimateIronmanHandler {
	...
	public static void handleQuickStore(Player player) {
		...
		if (!player.getDungeoneeringIronEquipment().getValidItems().isEmpty()
				|| !player.getDungeoneeringIronInventory().getValidItems().isEmpty()) {
	...
	public static void handleQuickRetrieve(Player player) {
		...
		if (!player.getEquipment().getValidItems().isEmpty()
				&& !player.getDungeoneeringIronEquipment().getValidItems().isEmpty()) {
		...
		if (total <= player.getInventory().getFreeSlots() && total > 0) {
		...
		} else if (!player.getDungeoneeringIronEquipment().getValidItems().isEmpty()) {
			int equip = player.getDungeoneeringIronEquipment().getValidItems().size();
			int leftover = player.getDungeoneeringIronInventory().getValidItems().size();
			for (Item i : player.getDungeoneeringIronEquipment().getValidItems()) {
				player.getInventory().add(i);
			...
			if (!player.getDungeoneeringIronInventory().getValidItems().isEmpty()) {
		...
		} else if (!player.getDungeoneeringIronInventory().getValidItems().isEmpty()) {
