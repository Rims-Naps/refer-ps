...
import com.ruse.world.content.newspinner.boxes.*;
...
public class MysteryBoxManager {
    ...
    public void openBox(int boxId) {
        ...
        if (boxId == 6199) {
            ...
            mysteryBox = new InfinCasket();
        } else if(boxId == 10248) {
            mysteryBox = new UniCasket();
        } else if(boxId == 10246) {
            mysteryBox = new GalCasket();
        } else {
            mysteryBox = null;
        }
            ...
            protected void execute() {
                ...
                if (random >= 59) {
                    ...
                    if (random > 92) {
                     ...
                     World.sendMessage("<img=24><col=0><shad=6C1894>[RARE]<img=24>@bla@<col=1986C0><shad=6C1894>" + player.getUsername() + " @bla@just received <col=1986C0><shad=6C1894>" +reward.getAmount()+"@red@<shad=0>x @red@<shad=0>" + ItemDefinition.forId(reward.getId()).getName() + "@bla@<shad=0></col> from a Casket!");
                    }
                }
