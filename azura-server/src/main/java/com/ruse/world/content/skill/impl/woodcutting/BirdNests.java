...
public class BirdNests {
	...
	public static void searchNest(Player p, int itemId) {
	 ...
	 * 
	 */
	public static void ringNest(Player p, int itemId) {
		if (itemId == 1046) {
	...
	private static void seedNest(Player p, int itemId) {
		if (itemId == 1044) {
			int random = Misc.getRandom(1000);
	...
	public static void eggNest(Player p, int itemId) {
		if (itemId == 1044) {
