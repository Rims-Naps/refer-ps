...
public class Barrows {
	...
	public static boolean handleObject(Player player, GameObject object) {
		...
		case 10284:
			...
			if (player.getMinigameAttributes().getBarrowsMinigameAttributes().getBarrowsData()[player
				...
				player.getPacketSender().sendMessage("<img=5><shad=0> @lre@You have looted a total of "
				...
				if (Misc.getRandom(100) >= 45) {
					...
					player.getPacketSender()
							.sendMessage("<img=5><col=009966><shad=0> Congratulations! You have just received "
	 ...
	 * @param attackspeed                            NPC attackspeed
	 * @param maxhit                                 NPC Maxhit
	 */
	public static void searchCoffin(Player player, int obj, int coffinId, int npcId,
                                    Position spawnPos) {
	...
	public static final int[][] COFFIN_AND_BROTHERS = { { 6823, 2030 }, { 6772, 2029 }, { 6773, 2027 },
			{ 6771, 2026 }, { 6821, 2025 } };
