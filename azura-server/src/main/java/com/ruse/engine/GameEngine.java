...
public final class GameEngine implements Runnable {
    ...
    public void init(){
        ...
        ScheduledExecutorService executorService = Executors.newSingleThreadScheduledExecutor(THREAD_FACTORY_BUILDER);
        ScheduledFuture<?> handle = executorService.scheduleAtFixedRate(this, 0,
