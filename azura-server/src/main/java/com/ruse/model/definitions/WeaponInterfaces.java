...
public final class WeaponInterfaces {
	...
	public static WeaponInterface getById(int id) {
	...
	public enum WeaponInterface {
		STAFF(328, 331, 6, new FightType[] { FightType.STAFF_BASH, FightType.STAFF_POUND, FightType.STAFF_FOCUS}, 7474, 7486),
		WARHAMMER(425, 428, 6,
		...
		SCYTHE(776, 779, 6, new FightType[] { FightType.SCYTHE_REAP,
		 ...
		 7536),
		CUSTOM_SCYTHE(776, 779, 5, new FightType[] { FightType.SCYTHE_REAP,
				FightType.SCYTHE_CHOP, FightType.SCYTHE_JAB, FightType.SCYTHE_BLOCK }, 7524,
				7536),
	...
	public static JsonLoader parseInterfaces() {
		return new JsonLoader("./data/def/json/weapon_interfaces.json") {
			@Override
	...
	public static void init() {
		...
		for (int id = 0; id < count; id++) {
			...
			if (lowerName.contains("staff")  || lowerName.contains("sceptre")) {
				...
				weaponInterface = WeaponInterface.WARHAMMER;
			} else if (lowerName.contains("scythe of sarkasm")) {
				weaponInterface = WeaponInterface.CUSTOM_SCYTHE;
