...
public enum Direction {
  ...
  //  public static final Direction[] EMPTY_DIRECTION_ARRAY = new Direction[0];
    ...
    public int deltaX() {
        return this == SOUTH_EAST || this == NORTH_EAST || this == EAST ? 1 :
                this == SOUTH_WEST || this == NORTH_WEST || this == WEST ? -1 : 0;
    }

    public int deltaY() {
        return this == NORTH_WEST || this == NORTH_EAST || this == NORTH ? 1 :
                this == SOUTH_WEST || this == SOUTH_EAST || this == SOUTH ? -1 : 0;
    }
