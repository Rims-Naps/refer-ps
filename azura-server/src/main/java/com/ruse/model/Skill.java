...
public enum Skill {
	...
	HITPOINTS(6216, 3, 1, 9768, 9769, -1, 10000, 188, 150, 113, 75, 113), // done
	...
	JOURNEYMAN(6221, 7, 5, 9795, 9796, 22026, 10000, 125, 100, 75, 50, 85), // done
	...
	ALCHEMY(7267, 3, 21, 9789, 9790, -1, 1, 1, 1, 1, 1, 1), // done
	BEAST_HUNTER(8267, 3, 22, 9948, 9949, 22024, 10000, 131, 105, 79, 53, 79), // done
	NECROMANCY(9267, 5, 23, 12169, 12170, 22033, 10000, 134, 107, 80, 54, 80), // done

	SOULRENDING(9267, 5, 24, 12169, 12170, 22033, 10000, 134, 107, 80, 54, 80), // done

	ARCANA(9267, 5, 25, 12169, 12170, 22033, 10000, 134, 107, 80, 54, 80),
	...
	public boolean isCombat() {
		return this == MAGIC || this == ATTACK || this == STRENGTH || this == DEFENCE || this == HITPOINTS || this == RANGED || this == PRAYER;
	}
