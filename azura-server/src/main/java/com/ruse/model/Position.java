...
public class Position {
    ...
    public Position(Position chest_position) {
        this.x = chest_position.getX();
        this.y = chest_position.getY();
        this.z = chest_position.getZ();
    }
    ...
    public boolean withinDistance(Position position, int distance) {
        return this.getZ() == position.getZ() && Math.abs(position.getX() - this.getX()) <= distance && Math.abs(position.getY() - this.getY()) <= distance;
    }
    ...
    public Position add(Position arrowQuadrant) {
        return arrowQuadrant;
    }
}