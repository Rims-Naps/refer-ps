        ...
        while (true) {
            ...
            try {
                ...
                if (response == LoginResponses.NEW_ACCOUNT) {
                    ...
                    if (GameSettings.server_logins_locked)
                        response = LoginResponses.LOGIN_BAD_SESSION_ID;
                    else
                ...
                logger.log(Level.SEVERE, "Error when handling login request from ${serviceRequest.login.channel}", e)
            }
        }
    }
